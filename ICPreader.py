...
ENDDATE = datetime.datetime(2014, 10, 1)


DESTFILENAME = "TOUICP.xlsx"
ERRORMSGPATH = "LogICP.txt"
COMPLETEDPATH = "ICPCompleted.txt"

ICPNUMBER = "0008001315TPCB8"
...
def CreateTOUFileDirs(basedir, starttime, endtime):
    ...
    while yearmo < endtime:
        ...
        subfoldername = "EIEP3_ICPHH"

        if yearmo.year <= 2014 and yearmo.month <= 9:  # Folder structure changed at this point
            subfoldername = "TOU"

        fullfp = os.path.join(basedir, yearstr, yearmostr, subfoldername)
